...
- **[`voice-agent/`](voice-agent/)** — the running system: six independent
  ...
  swapped without touching the others. See
  [`voice-agent/README.md`](voice-agent/README.md) for the architecture,
  service protocols, and the web UI's live pipeline inspector.
